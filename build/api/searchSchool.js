...
exports.default = (function (school) { return __awaiter(void 0, void 0, void 0, function () {
    var regionCode, schoolLevelCode, queryParams, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                regionCode = constants_1.default.regions[school.region];
                schoolLevelCode = constants_1.default.schoolLevels[school.level];
                if (!regionCode)
                    throw new Error('올바르지 않은 지역 이름이 입력되었어요! 다시 확인해주세요!');
                else if (!schoolLevelCode)
                    throw new Error('올바르지 않은 학교급이 입력되었어요! 다시 확인해주세요!');
                queryParams = new url_1.URLSearchParams();
...
//# sourceMappingURL=searchSchool.js.map